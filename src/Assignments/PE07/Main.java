 ...
 *  Practice Exercise 7- Transcations
 *  10/31/2019
 */
...
public class Main {
    public static void main(String[] args) throws DLException {
        try {
            ...
            eq.fetch();
            System.out.println("After Swap- Equip ID: "+eq.equipmentID);
            eq.swap(894);
            eq.fetch();

            Equipment eq1=new Equipment(894);
            System.out.println("After Swap- Equip ID: "+eq1.equipmentID);
            eq1.fetch();
